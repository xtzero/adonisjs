...
## Installation
Vite comes pre-configured with the [web starter kit](/guide/install/#web-starter-kit-spannot-ready-yetclassbadge). However, you can follow the below instructions to configure it inside an existing AdonisJS project.
...
## Referencing assets inside Edge templates {#referencing-assets-inside-edge-templates}
