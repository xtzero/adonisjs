...
As we discussed in the [IoC container guide](/guide/ioc_container/index.html#container-bindings), the container bindings are one of the primary reasons for the IoC container to exists in AdonisJS.
