...
Middleware classes are instantiated using the [IoC container](/guide/ioc_container); therefore, you can type-hint dependencies inside the middleware constructor, and the container will inject them for you.
